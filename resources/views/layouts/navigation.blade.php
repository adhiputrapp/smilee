<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
    ...
    <div class="mx-auto px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-blue-500 via-yellow-400 to-green-400">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                     ...
                     data-te-sidenav-toggle-ref data-te-target="#sidenav-8" aria-controls="#sidenav-8"
                     aria-haspopup="true">
