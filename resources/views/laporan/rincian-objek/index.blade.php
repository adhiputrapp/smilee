<x-app-layout>
    <h1 class="mb-6 text-3xl font-bold border-b-2">Rincian Objek</h1>

    <div class="mb-3 w-full">
        <div class="relative mb-4 mr-2 flex w-full flex-wrap items-stretch">
            <form action="{{ route('rincian.objek.export') }}" method="POST">
                @csrf
                ...
                <div class="mb-4">
                    ...
                    <select name="kodering" id="kodering">
                        <option value="">-</option>
    ...
    @push('script')
        ...
        $(document).ready(function() {
            ...
            $('#kodering').on('select2:select', function(e) {
                e.preventDefault()

                $.ajax({
                    url: "{{ route('rincian.objek.search') }}",
                    type: "GET",
                    dataType: 'JSON',
                    data: {
