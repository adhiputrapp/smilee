<x-app-layout>
    <h1 class="mb-6 text-3xl font-bold border-b-2">Halaman Sub Kegiatan</h1>
    ...
    <div class="mb-3 w-full">
        ...
        @if (Auth::user()->can('subkegiatans.create'))
        <a href="{{route('subkegiatans.create')}}"
        data-te-ripple-init
        data-te-ripple-color="light"
    ...
    @push('script')
        <script>
            var subkegiatan = {{ Js::from($subkegiatans) }}
            ...
            const data = {
                ...
                rows: subkegiatan.map((row) => {
                    return {
                        ...
                        @if (Auth::user()->can('subkegiatans.delete'))
                        <a href="javascript:void(0);" onclick="destroyFunction('{{ url('/subkegiatan/delete/${row.id}') }}');" class="inline-block rounded  bg-gradient-to-l from-red-600 to-red-500 px-6 pb-2 pt-2.5 text-xs font-medium uppercase leading-normal text-white shadow-[0_4px_9px_-4px_#dc4c64] transition duration-150 ease-in-out hover:bg-danger-600 hover:shadow-[0_8px_9px_-4px_rgba(220,76,100,0.3),0_4px_18px_0_rgba(220,76,100,0.2)] focus:bg-danger-600 focus:shadow-[0_8px_9px_-4px_rgba(220,76,100,0.3),0_4px_18px_0_rgba(220,76,100,0.2)] focus:outline-none focus:ring-0 active:bg-danger-700 active:shadow-[0_8px_9px_-4px_rgba(220,76,100,0.3),0_4px_18px_0_rgba(220,76,100,0.2)] dark:shadow-[0_4px_9px_-4px_rgba(220,76,100,0.5)] dark:hover:shadow-[0_8px_9px_-4px_rgba(220,76,100,0.2),0_4px_18px_0_rgba(220,76,100,0.1)] dark:focus:shadow-[0_8px_9px_-4px_rgba(220,76,100,0.2),0_4px_18px_0_rgba(220,76,100,0.1)] dark:active:shadow-[0_8px_9px_-4px_rgba(220,76,100,0.2),0_4px_18px_0_rgba(220,76,100,0.1)]">
                            Delete
                        </a>
                        @endif
                            `
