<x-app-layout>
    <h1 class="mb-6 text-3xl font-bold border-b-2">Halaman Kodering</h1>
    ...
    @push('script')
        <script>
            var kodering = {{ Js::from($koderings) }}
            ...
            const data = {
                ...
                rows: kodering.map((row) => {
                    return {
                        ...row,
                        subkegiatan: row.subkegiatan ? `${row.subkegiatan.nama_sub_kegiatan} - ${row.subkegiatan.kegiatan.nama_kegiatan} - ${row.subkegiatan.kegiatan.program.nama_program} - ${row.subkegiatan.kegiatan.program.biro.nama_biro}` : 'Belum ada program',
                        action: `
                            ...
                            <a href="javascript:void(0);" onclick="destroyFunction('{{ url('/kodering/delete/${row.id}') }}');" class="inline-block rounded  bg-gradient-to-l from-red-600 to-red-500 px-6 pb-2 pt-2.5 text-xs font-medium uppercase leading-normal text-white shadow-[0_4px_9px_-4px_#dc4c64] transition duration-150 ease-in-out hover:bg-danger-600 hover:shadow-[0_8px_9px_-4px_rgba(220,76,100,0.3),0_4px_18px_0_rgba(220,76,100,0.2)] focus:bg-danger-600 focus:shadow-[0_8px_9px_-4px_rgba(220,76,100,0.3),0_4px_18px_0_rgba(220,76,100,0.2)] focus:outline-none focus:ring-0 active:bg-danger-700 active:shadow-[0_8px_9px_-4px_rgba(220,76,100,0.3),0_4px_18px_0_rgba(220,76,100,0.2)] dark:shadow-[0_4px_9px_-4px_rgba(220,76,100,0.5)] dark:hover:shadow-[0_8px_9px_-4px_rgba(220,76,100,0.2),0_4px_18px_0_rgba(220,76,100,0.1)] dark:focus:shadow-[0_8px_9px_-4px_rgba(220,76,100,0.2),0_4px_18px_0_rgba(220,76,100,0.1)] dark:active:shadow-[0_8px_9px_-4px_rgba(220,76,100,0.2),0_4px_18px_0_rgba(220,76,100,0.1)]">
                                Delete
                            </a>`
                    }
                })
