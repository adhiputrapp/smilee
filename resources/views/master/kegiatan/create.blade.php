<x-app-layout>
    <h1 class="text-3xl font-bold border-b-2">Input Kegiatan</h1>
    <div class="py-12">
            ...
            <div class="bg-gradient-to-tr from-slate-300 to-slate-400 overflow-hidden shadow-sm sm:rounded-lg p-4 mb-4">
                ...
                <form action="{{ route('kegiatans.store') }}" method="POST">
                    ...
                    <div class="form-group mb-5">
                        ...
                        <x-text-input type="text" name="kode_kegiatan" id="kode_kegiatan" class="block mt-1 w-full" required/>
                    </div>
                    <div class="form-group mb-5">
                        <x-input-label for="nama_kegiatan" :value="__('Nama kegiatan')"/>
                        <x-text-input type="text" name="nama_kegiatan" id="nama_kegiatan" class="block mt-1 w-full" required/>
                    </div>
                    <div class="form-group mb-5">
